...
public class tretie {
    Deque<Integer> firstpl, secpl;

    public tretie(String firstpl, String secpl) {
    ...
    public static void main(String[] args) {
        System.out.println(new tretie("13579", "24680").play());
        System.out.println(new tretie("12345", "67890").play());
        System.out.println(new tretie("13029", "42685").play());
    }
