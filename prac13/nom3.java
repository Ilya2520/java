...
public class nom3{
    ...
    public static void main(String[] args) {
        Address first = new Address("Russia, Chechya, Grozny, street1, 1, 12, 123", 0);
        Address second = new Address("Russia, Dagestan, Dagestan, street race, 126, 2, 31", 1);
        Address third = new Address("Russia; MOSCOW; Moscow; Arbat; 261; 12; 13", 1);
        Address fourth = new Address("Russia. Leningrad. SPB. Dumskaya. 216. 22. 33", 1);
